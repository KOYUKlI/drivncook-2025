...
<head>
    ...
    <title>{{ __('ui.errors.419.title') }} - {{ config('app.name', 'DrivnCook') }}</title>
...
<body class="font-sans text-gray-900 antialiased bg-gradient-to-br from-yellow-50 to-orange-50 min-h-screen">
    <div class="min-h-screen flex flex-col justify-center items-center">
        <!-- Logo -->
        <div class="flex flex-col items-center mb-8">
            <div class="w-16 h-16 bg-gradient-to-br from-yellow-500 to-orange-600 rounded-full flex items-center justify-center mb-4 shadow-lg">
        ...
        <div class="w-full max-w-md px-6 py-8 bg-white shadow-xl rounded-2xl border border-gray-100 text-center">
            <div class="mb-6">
                <div class="text-6xl font-bold text-yellow-600 mb-2">419</div>
                <h2 class="text-2xl font-semibold text-gray-800 mb-2">{{ __('ui.errors.419.heading') }}</h2>
                <p class="text-gray-600">{{ __('ui.errors.419.message') }}</p>
            </div>

            <!-- Info Box -->
            <div class="mb-6 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
                <p class="text-yellow-700 text-sm">
                    {{ __('ui.errors.419.help') }}
                </p>
            </div>
