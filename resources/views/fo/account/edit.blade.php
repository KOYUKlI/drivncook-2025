    ...
    <div class="p-6">
        @if (session('status') === 'account-updated')
            <div class="bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded relative mb-4" role="alert">
                <span class="block sm:inline">{{ __('ui.fo.account.messages.updated') }}</span>
            </div>
        @endif
        ...
        <form method="post" action="{{ route('fo.account.update') }}" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="email" name="email" id="email" value="{{ $user->email }}" disabled readonly
                           class="bg-gray-100 border border-gray-300 text-gray-600 rounded-md w-full px-3 py-2 cursor-not-allowed">
                ...
                <div>
                    ...
                    <input type="tel" name="phone" id="phone" value="{{ old('phone', $user->phone) }}" 
                           ...
                           class="border border-gray-300 rounded-md w-full px-3 py-2 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500">
                </div>
                ...
                <div class="flex items-center">
                    ...
                    <input type="checkbox" name="notification_email_optin" id="notification_email_optin" value="1" 
                           {{ old('notification_email_optin', $user->notification_email_optin) ? 'checked' : '' }}
