<div class="grid md:grid-cols-3 gap-4">
  ...
  <div>
    <label class="block text-sm font-medium">{{ __('Taux rachat (1 pt => €)') }}</label>
  ...
  <div>
    <label class="block text-sm font-medium">{{ __('Expiration (mois)') }}</label>
...
<div class="mt-4 flex items-center gap-3">
  ...
  <a href="{{ route('admin.loyalty-rules.index') }}" class="text-gray-600">{{ __('Annuler') }}</a>
</div>
