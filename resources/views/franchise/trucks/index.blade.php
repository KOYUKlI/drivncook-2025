...
@section('content')
<h1 class="text-2xl font-bold mb-4">My Trucks</h1>

<a href="{{ route('franchise.trucks.create') }}" class="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600">Add Truck</a>
    ...
    @foreach($trucks as $truck)
        <tr class="border-b">
            ...
            <td class="py-2 px-4 text-center">
                <a href="{{ route('franchise.trucks.show', $truck) }}" class="text-blue-600 hover:underline">View</a> |
                <a href="{{ route('franchise.trucks.edit', $truck) }}" class="text-yellow-600 hover:underline">Edit</a> |
